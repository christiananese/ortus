    ...
    <Layout title="Umgebung" intl={intl}>
      <div className="relative pt-12 pb-10 md:pt-24 md:pb-16 mb-8 sm:mb-0">
        ...
        >
          ...
          <SwiperSlide className="max-w-4xl">
            {({ isActive }) => (
              <Image
                ...
                src="/room/slider/terrasse_1.png"
                alt="Terasse mit Blick ins Tal"
                width="1200"
                height="800"
              />
            )}
          ...
          <SwiperSlide className="max-w-4xl">
            {({ isActive }) => (
              <Image
                ...
                src="/room/slider/terrasse_2.png"
                alt="Badezimmer"
                width="1200"
                height="800"
              />
          ...
          <SwiperSlide className="max-w-xl max-h-[400px]">
            {({ isActive }) => (
              <Image
                className={`max-w-full h-auto ${
                  isActive ? "opacity-100" : "opacity-30"
                }`}
                src="/room/slider/terrasse_3.png"
                alt="Badezimmer"
                height="800"
                width="600"              />
            )}
      ...
      <div className="grid items-center md:grid md:gap-12 md:grid-cols-12 lg:gap-20">
        <div className="col-span-10 md:col-start-2 md:col-span-10 flex flex-col justify-center items-center text-center">
          ...
          <p
            ...
            dangerouslySetInnerHTML={{ __html: da.garden.ammenities }}
          />
          <p
            className={
              "text-xl text-default max-w-prose pt-12 md:max-w-screen-md md:pt-8 md:text-gray-600"
            }
            dangerouslySetInnerHTML={{ __html: da.garden.ammenities2 }}
          />
          <p
            className={
              "text-xl text-default max-w-prose pt-12 md:max-w-screen-md md:pt-8 md:text-gray-600"
      ...
      <div className="grid items-center md:grid md:gap-12 md:grid-cols-12 lg:gap-20 pb-12">
        <div className="col-span-10 md:col-start-2 md:col-span-10 flex flex-col justify-center items-center text-center">
          ...
          <p
            className={
              "text-sm text-default max-w-prose md:max-w-screen-md md:text-gray-600"
            }
          >
            {da.stornoLink}
            <Link href="/storno">
          ...
          <p
            ...
            dangerouslySetInnerHTML={{ __html: da.storno }}
          />
          <p
            className={
              "text-sm text-default max-w-prose pt-12 md:max-w-screen-md md:pt-8 md:text-gray-600"
